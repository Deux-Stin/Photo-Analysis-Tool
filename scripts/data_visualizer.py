...
<<<<<<< HEAD
    ...
    def load_folders(self, directory):
        # Utilisez `directory` pour charger les dossiers contenant des images avec EXIF
        if directory:  # Vérifiez si directory n'est pas None avant de continuer
            data = self.get_folders(directory)
